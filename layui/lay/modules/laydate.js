	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		if(t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function(e) {
				...
				var a = w.elem("div", {
					...
					i = [function() {
						var e = w.elem("i", {
							"class": "layui-icon laydate-icon laydate-prev-y fa fa-angle-double-left"
						});
						return e.innerHTML = "", e
					}(), function() {
						var e = w.elem("i", {
							"class": "layui-icon laydate-icon laydate-prev-m fa fa-angle-left"
						});
						return e.innerHTML = "", e
					}(), function() {
						var e = w.elem("div", {
						...
						var e = w.elem("i", {
							"class": "layui-icon laydate-icon laydate-next-m fa fa-angle-right"
						});
						return e.innerHTML = "", e
					}(), function() {
						var e = w.elem("i", {
							"class": "layui-icon laydate-icon laydate-next-y fa fa-angle-double-right "
						});
						return e.innerHTML = "", e
					}()],
					d = w.elem("div", {
